...
export const enhancedTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    zIndexOverrides: [
      {
        selector: '[data-tutorial-id="marketplace-link"]',
        zIndex: 10000,
        createStackingContext: true
      }
    ],
  ...
  },
  {
    ...
    onBeforeStep: async () => {
      console.log('[Tutorial Config] coin-detail-overview: onBeforeStep - ensuring order book tab is active.');
      await new Promise(resolve => setTimeout(resolve, 500));
    },
  },
  {
    ...
    onBeforeStep: async () => {
      console.log('[Tutorial Config] coin-history-tab-highlight: onBeforeStep - ensuring history tab is active.');
  ...
  },
  {
    ...
    onBeforeStep: async () => {
      console.log('[Tutorial Config] coin-details-tab-highlight: onBeforeStep - ensuring details tab is active.');
      await new Promise(resolve => setTimeout(resolve, 800));
    },
  },
  {
